...
const container = document.getElementById('catalogoPs5');
...
`).join(''); 
container.innerHTML = tarjetasHTMLps5;
...
const catalogoPS4 = [
    ...
    {
        name: "last of us part 2 ps4",
        price: 30000,
        img: "../assets/part2.jpg",
        alt: "last-of-us-part2"
    },
    {
        name: "sackboy ps4",
        price: 16100,
        img: "../assets/sackboy.jpg",
        alt: "sackboy"
    },
    {
        name: "miles morales ps4",
        price: 32750,
        img: "../assets/miles.jpg",
        alt: "spider-miles-morales"
    },
    {
        name: "uncharted ps4",
        price: 19600,
...
const containerDos = document.getElementById('catalogoPs4');
...
`).join(''); 
containerDos.innerHTML = tarjetasHTMLps4;